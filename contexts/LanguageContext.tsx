...
const translations = {
    id: {
        ...
        // Property Detail
        'prop.price': 'Harga',
        'prop.installmentStart': 'Angsuran Mulai',
        'prop.perMonth': 'per bulan',
        'prop.freeFees': 'Bebas Biaya KPR & Notaris',
        'prop.contactUs': 'Hubungi Kami',
        'prop.landArea': 'Luas Tanah',
        'prop.buildingArea': 'Luas Bangunan',
        'prop.bathrooms': 'Kamar Mandi',
        'prop.bedrooms': 'Kamar Tidur',
        'prop.benefits': 'Keunggulan Utama',
        'prop.benefit1Title': 'Bebas Biaya',
        'prop.benefit1Desc': 'Gratis biaya KPR, BPHTB & Notaris',
        'prop.benefit2Title': 'Legalitas Aman',
        'prop.benefit2Desc': 'Sertifikat SHM & IMB sudah pecah',
        'prop.buildingSpec': 'Spesifikasi Bangunan',
        'prop.floors': 'Jumlah Lantai',
        'prop.yearBuilt': 'Tahun Dibangun',
        'prop.maidBath': 'Kamar Mandi ART',
        'prop.maidBed': 'Kamar Tidur ART',
        'prop.additionalSpec': 'Spesifikasi Tambahan',
        'prop.electricity': 'Listrik',
        'prop.water': 'Air',
        'prop.orientation': 'Arah Hadap',
        'prop.certificate': 'Sertifikat',
        'prop.description': 'Deskripsi',
        'prop.kprCalculator': 'Kalkulator KPR',
        'prop.propertyPrice': 'Harga Properti',
        'prop.dp': 'Uang Muka (DP)',
        'prop.tenor': 'Jangka Waktu',
        'prop.years': 'Tahun',
        'prop.estimatedInstallment': 'Estimasi Angsuran',
        'prop.simulationDetail': 'Lihat Detail Simulasi',
        'prop.scheduleVisit': 'Jadwalkan Kunjungan',
        'prop.pickDate': 'Pilih Tanggal',
        'prop.note': 'Catatan',
        'prop.notePlaceholder': 'Ada pertanyaan khusus?',
        'prop.scheduleButton': 'Jadwalkan Sekarang',
        'prop.location': 'Lokasi',
        'prop.mapUnavailable': 'Peta tidak tersedia',
        'prop.nearbyAccess': 'Akses Terdekat',
        'prop.reviews': 'Ulasan',
    ...
    en: {
        ...
        // Property Detail
        'prop.price': 'Price',
        'prop.installmentStart': 'Installment Starts From',
        'prop.perMonth': 'per month',
        'prop.freeFees': 'Free KPR & Notary Fees',
        'prop.contactUs': 'Contact Us',
        'prop.landArea': 'Land Area',
        'prop.buildingArea': 'Building Area',
        'prop.bathrooms': 'Bathrooms',
        'prop.bedrooms': 'Bedrooms',
        'prop.benefits': 'Key Benefits',
        'prop.benefit1Title': 'Free Fees',
        'prop.benefit1Desc': 'Free Mortgage, Tax & Notary fees',
        'prop.benefit2Title': 'Secure Legality',
        'prop.benefit2Desc': 'SHM & IMB certificates already split',
        'prop.buildingSpec': 'Building Specifications',
        'prop.floors': 'Floors',
        'prop.yearBuilt': 'Year Built',
        'prop.maidBath': 'Maid Bathroom',
        'prop.maidBed': 'Maid Bedroom',
        'prop.additionalSpec': 'Additional Specifications',
        'prop.electricity': 'Electricity',
        'prop.water': 'Water',
        'prop.orientation': 'Orientation',
        'prop.certificate': 'Certificate',
        'prop.description': 'Description',
        'prop.kprCalculator': 'Mortgage Calculator',
        'prop.propertyPrice': 'Property Price',
        'prop.dp': 'Down Payment (DP)',
        'prop.tenor': 'Tenure',
        'prop.years': 'Years',
        'prop.estimatedInstallment': 'Estimated Installment',
        'prop.simulationDetail': 'View Simulation Details',
        'prop.scheduleVisit': 'Schedule a Visit',
        'prop.pickDate': 'Select Date',
        'prop.note': 'Note',
        'prop.notePlaceholder': 'Any specific questions?',
        'prop.scheduleButton': 'Schedule Now',
        'prop.location': 'Location',
        'prop.mapUnavailable': 'Map unavailable',
        'prop.nearbyAccess': 'Nearby Access',
