      ...
      <div className="relative max-w-[1600px] mx-auto px-10 pt-24 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            ...
            <p className="text-slate-400 text-base leading-relaxed max-w-md font-medium">
              Mitra terpercaya Anda dalam menemukan hunian premium dan aset investasi bernilai tinggi di Bekasi dan sekitarnya. Prioritas kami adalah keamanan legalitas dan kepuasan Anda.
            </p>
          ...
          <div className="lg:col-span-2">
            <h4 className="font-bold text-white mb-8 text-sm uppercase tracking-widest border-b border-white/10 pb-4 inline-block">Properti</h4>
            <ul className="space-y-4 text-sm font-medium">
              <li><a href="#" className="hover:text-emerald-400 transition-colors flex items-center gap-2 group"><span className="w-0 group-hover:w-2 h-[1px] bg-emerald-500 transition-all"></span> Rumah Dijual</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors flex items-center gap-2 group"><span className="w-0 group-hover:w-2 h-[1px] bg-emerald-500 transition-all"></span> Ruko Premium</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors flex items-center gap-2 group"><span className="w-0 group-hover:w-2 h-[1px] bg-emerald-500 transition-all"></span> Tanah Kavling</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors flex items-center gap-2 group"><span className="w-0 group-hover:w-2 h-[1px] bg-emerald-500 transition-all"></span> Gudang Industri</a></li>
            </ul>
          </div>

          <div className="lg:col-span-2">
            <h4 className="font-bold text-white mb-8 text-sm uppercase tracking-widest border-b border-white/10 pb-4 inline-block">Area Favorit</h4>
            <ul className="space-y-4 text-sm font-medium">
          ...
          <div className="lg:col-span-3" id="kontak">
            <h4 className="font-bold text-white mb-8 text-sm uppercase tracking-widest border-b border-white/10 pb-4 inline-block">Hubungi Kami</h4>
            <ul className="space-y-6">
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-slate-500 mb-1">Office</span>
              ...
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-slate-500 mb-1">WhatsApp</span>
              ...
              <li className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-slate-500 mb-1">Email</span>
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">
            © 2024 {COMPANY_NAME}. <span className="hidden md:inline">|</span> All Rights Reserved.
          </p>
